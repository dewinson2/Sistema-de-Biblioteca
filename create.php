...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO cliente (nombre, identificacion, telefono) VALUES ('$nombre', '$ID', '$telefono')";
    ...
    <div class="container">
        <div class="form-container">
            ...
            <form action="create.php" method="post">
                ...
                <input type="text" id="ID" name="ID" required placeholder="Ingrese el ID">
                
                <label for="telefono">Teléfono:</label>
                <input type="tel" id="telefono" name="telefono" required placeholder="Ingrese el teléfono" pattern="[0-9]{10}">
