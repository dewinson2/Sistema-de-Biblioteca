<?php 
include 'db.php';
$sql = "SELECT id, titulo, autor, isbn, numero_edicion, costo_diario_mora FROM libro";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($sql) === TRUE) {
        echo "Libro ${id} eliminado exitosamente";
    } else {
        echo "Hubo un error eliminando el libro ${id}: " . $conn->error;
    }
}
?>
        ...
        <table>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . $row["costo_diario_mora"] . "</td>";
                    echo "<td>
                            ...
                            <form action='actualizar.php' method='GET'>
                                ...
                                <input type='hidden' name='costo_diario_mora' value='{$row['costo_diario_mora']}'>
